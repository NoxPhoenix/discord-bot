...
const gamers = {
  createCache(member, gamerInfo) {
    ...
    // validGamerInfo(gamerInfo, (valid) => {
    //   console.log('valid', valid);
    //   if (valid === true) return stats.initiateMember(member, gamerInfo, memberCache => cb(memberCache));
    //   return cb(`No rocket league stats found for ${gamerInfo.id} on ${gamerInfo.platform}`);
    // });
  },
