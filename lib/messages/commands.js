    ...
    switch (args[0]) {
      ...
      case 'me':
        return players.getRank(message.member.id)
          ...
          .catch(err => message.reply(err.message));
      case 'help':
        return message.reply(`You can set your profile with ${config.prefix}stats set (platform) (id)
        You can check your stats with ${config.prefix}stats me (Only once your profile has been set.)`);
      default:
